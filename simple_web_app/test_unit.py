...
def test_8_char_with_invalid_especial_character_should_raise_exception():
    # given
    validator = PasswordValidator(content="@A1@a/^~")
    with pytest.raises(InvalidEspecialCharacterException):  # then
        # when
        validator.password_validate()
